...
default["openstack"]["db"]["image"]["host"] = "10.125.0.15"
default['openstack']['endpoints']['image-registry']['host'] = node["network"]["interfaces"]["eth1"]["addresses"].select {|address, data| data["family"] == "inet" }.first.first

#Glance Endpoint (Keystone Service Endpoint)
default['openstack']['endpoints']['image-api']['host'] = "10.125.0.11"
...
default["openstack"]["image"]["api"]["bind_interface"] = "eth1"
...
# otherwise it will bind to the API endpoint's host.
default["openstack"]["image"]["registry"]["bind_interface"] = "eth1"
