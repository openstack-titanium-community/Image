...
# TO DO : Remove attributes (testing)
...
# default['openstack']['db']['image']['host'] = '10.49.118.60'
override["openstack"]["db"]["image"]["port"] = "3306"
# Remaining attributes
override['openstack']['db']['image']['db_type'] = "mysql"
override["openstack"]["db"]["image"]["db_name"] = "glance"

#Keystone Attributes
# default['openstack']['endpoints']['identity-admin']['host'] = "10.49.118.60"
...
# default['openstack']['endpoints']['identity-api']['host'] = "10.49.118.60"
...
# Glance Registry Attributes (Used in Glance config files) 
# override keyword is used for Glance "final" attributes --> Those values are not meant to be changed somewhere else as they are related to Glance component 
default['openstack']['endpoints']['image-registry']['host'] = ipaddress
override['openstack']['endpoints']['image-registry']['port'] = "9191"
# Remaining attributes
override['openstack']['endpoints']['image-registry']['scheme'] = "http"
override['openstack']['endpoints']['image-registry']['path'] = "/v2"

#Glance Endpoint (Keystone Service Endpoint)
#['image-api']['host'] is only used to build Keystone Endpoint --> change with virtual ip address
default['openstack']['endpoints']['image-api']['host'] = ipaddress
override['openstack']['endpoints']['image-api']['port'] = "9292"
# Remaining attributes
override['openstack']['endpoints']['image-api']['scheme'] = "http"
override['openstack']['endpoints']['image-api']['path'] = "/v2"
...
default["openstack"]["image"]["rabbit"]["host"] = "10.125.0.19"
...
default["openstack"]["image"]["api"]["bind_interface"] = "eth0"
...
# otherwise it will bind to the API endpoint's host.
default["openstack"]["image"]["registry"]["bind_interface"] = "eth0"
