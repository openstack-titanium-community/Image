...
# default["openstack"]["endpoints"]["identity-admin"]["host"] = node["network"]["interfaces"]["eth1"]["addresses"].select {|address, data| data["family"] == "inet" }.first.first
...
# default["openstack"]["endpoints"]["identity-api"]["host"] = node["network"]["interfaces"]["eth1"]["addresses"].select {|address, data| data["family"] == "inet" }.first.first
